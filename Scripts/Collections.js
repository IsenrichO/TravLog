...
// Declaration of trip iterator, 'tripNum':
var tripNum = 1;


// Global reference object, 'countryObject', containing summary information and content links to the respective country indicated by each key value: 
var	countryObject = {
	Afghanistan: {
	...
	Anguilla: {
		map: "https://upload.wikimedia.org/wikipedia/commons/2/27/Anguilla_on_the_globe_%28Americas_centered%29",
		flag: "https://upload.wikimedia.org/wikipedia/commons/b/b4/Flag_of_Anguilla",
		coat: "https://upload.wikimedia.org/wikipedia/commons/6/67/Coat_of_arms_of_Anguilla",
		ISO: "AI",
		capital: "The Valley (British Overseas Territory)",
		coords: {lat: 18.22723, lng: -63.04899}
	},
	Antarctica: {
		...
		ISO: "AQ",
		capital: "N/A (Territorial Landmass)",
	...
	Asia: {
		...
		ISO: "",
		capital: "N/A (Continent)",
		coords: {lat: 43.6748, lng: 87.3325}			// Geographical Centre: Kyzyl
	},
	Australia: {
	...
	"Congo, Democratic Republic of The": {
		...
		coat: "https://upload.wikimedia.org/wikipedia/commons/1/1b/Coat_of_arms_of_the_Democratic_Republic_of_the_Congo",
		ISO: "CD",
		capital: "Kinshasa",
		coords: {lat: 0.0000, lng: 25.0000}			// Zaire: {lat: -2.88, lng: 23.656}
	},
	...
	Europe: {
		...
		ISO: "",
		capital: "N/A (Continent)",
		coords: {lat: 54.9000, lng: 25.316667}
	},
	"Falkland Islands": {
	...
	Guam: {
		map: "https://upload.wikimedia.org/wikipedia/commons/9/94/Guam_on_the_globe_%28small_islands_magnified%29_%28Polynesia_centered%29",
		flag: "https://upload.wikimedia.org/wikipedia/commons/0/07/Flag_of_Guam",
		coat: "https://upload.wikimedia.org/wikipedia/commons/b/b0/Coat_of_arms_of_Guam",
		ISO: "GU",
		capital: "Hagåtña",
		coords: {lat: 13.4667, lng: 144.7833}
	},
	Guatemala: {
	...
	"North America": {
		...
		ISO: "",
		capital: "N/A (Continent)",
		coords: {lat: 48.166667, lng: -100.166667}		// Rugby, ND: {lat: 48.3548, lng: -99.9989}
	},
	...
	"St. Barthélemy": {
		map: "https://upload.wikimedia.org/wikipedia/commons/3/3e/Saint_Barthelemy_on_the_globe_%28Americas_centered%29",
		flag: "https://upload.wikimedia.org/wikipedia/commons/d/df/Flag_of_Saint_Barthelemy_%28local%29",
		coat: "https://upload.wikimedia.org/wikipedia/commons/3/35/Blason_St_Barth%C3%A9l%C3%A9my_TOM_entire",
		ISO: "BL",
		capital: "",
		coords: {lat: 17.9, lng: -62.833333}
	},
	"St. Kitts & Nevis": {
	...
	Scandinavia: {
		map: "http://vignette2.wikia.nocookie.net/conworld/images/9/91/Scandinavia_%28orthographic_projection%29",
		flag: "https://upload.wikimedia.org/wikipedia/commons/6/6c/Flag_of_Sk%C3%A5ne",
		coat: "https://upload.wikimedia.org/wikipedia/commons/4/44/Nordic_cross_flags_of_Northern_Europe",
		ISO: "",
		capital: "N/A (Territorial Landmass)",
		coords: {lat: 62.0000, lng: 10.0000}
	},
	Scotland: {
		...
		coat: "https://upload.wikimedia.org/wikipedia/commons/9/93/Royal_Coat_of_Arms_of_the_Kingdom_of_Scotland",
		ISO: "",
		capital: "Edinburgh",
		coords: {lat: 56.816922, lng: -4.18265}
	},
	Senegal: {
	...
	"South America": {
		...
		ISO: "",
		capital: "N/A (Continent)",
		coords: {lat: 15.595833, lng:  -56.096944}		// Geographical centre, Cuiabá
	},
	"South Sudan": {
	...
	"Southeast Asia": {
		map: "https://upload.wikimedia.org/wikipedia/commons/f/f7/Southeast_Asia_%28orthographic_projection%29",
		flag: "",
		coat: "",
		ISO: "",
		capital: "N/A (Territorial Landmass)"
	...
	"United Kingdom": {
		...
		coat: "https://upload.wikimedia.org/wikipedia/commons/9/98/Royal_Coat_of_Arms_of_the_United_Kingdom",
		ISO: "GB",
		capital: "London",
		coords: {lat: 54.0000, lng: -2.0000}
	},
	...
	Wales: {
		...
		ISO: "",
		capital: "Cardiff",
		coords: {lat: 52.33022, lng: -3.766409}
	},
	"Western Sahara": {
	...
	Zaire: {
		...
		coat: "https://upload.wikimedia.org/wikipedia/commons/d/d9/Coats_of_arms_of_Zaire_%281971-1997%29",
		ISO: "CD",
		capital: "Kinshasa",
		coords: {lat: -2.88, lng: 23.656}
	},
	Zambia: {
...
/* Format for declaration of keys & values within the 'countryObject' object, as shown above:
	
	var countryObject = {
		<countryName>: {
			map: 		<".SVG Map Image URL">
			flag: 	 	<.SVG Flag Image URL>
			coat: 		<.SVG State Seal Image URL>
			ISO: 		<ISO 3166-1 Alpha-2 Two-Letter Country Code>
			capital: 	<Country Capital City>
			coords: {
				lat: 	<Latitude of Geographical Centre of Country>
				lng: 	<Longitude of Geographical Centre of Country>
			}
		}
	}																						*/
...
var countriesByContinent = {
	Africa: [
		...
		"Cameroon", "Cape Verde", "Central African Republic", "Chad", "Comoros", "Congo, Republic of The", "Congo, Democratic Repbulic of The",
		"Djibouti",
		...
		"Rwanda",
		"São Tomé & Príncipe", "Senegal", "Seychelles", "Sierra Leone", "Somalia", "South Africa", "South Sudan", "Sudan", "Swaziland",
	...
	"North America": [
		...
		"Cayman Islands", "Clipperton Island", "Curaçao",
		"Greenland", "Guadeloupe",
		"Martinique", "Montserrat",
		"Puerto Rico",
		"Saba", "Saint Barthélemy", "Saint Martin", "Saint Pierre & Miquelon", "Sint Eustatius", "Sint Maarten",
